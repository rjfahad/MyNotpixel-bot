...
if [ ! -d "MyNotpixel-bot" ]; then
    ...
    echo -e "${GREEN}Installation completed! You can now configure your settings in the .env file.${NC}"
else
    echo -e "${GREEN}MyNotpixel-bot is already installed. You can configure your settings in the .env file.${NC}"
fi
